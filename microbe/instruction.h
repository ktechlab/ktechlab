...
class Instr_addwf : public Instruction
{
	public:
		...
		virtual void generateLinksAndStates( Code::iterator current ) override;
		virtual ProcessorBehaviour behaviour() const override;
		virtual AssemblyType assemblyType() const override { return FileOriented; }
};
...
class Instr_bcf : public Instruction
{
	public:
		...
		virtual void generateLinksAndStates( Code::iterator current ) override;
		virtual ProcessorBehaviour behaviour() const override;
		virtual AssemblyType assemblyType() const override { return BitOriented; }
};
...
class Instr_btfsc : public Instruction
{
	public:
		...
		virtual void generateLinksAndStates( Code::iterator current ) override;
		virtual ProcessorBehaviour behaviour() const override;
		virtual AssemblyType assemblyType() const override { return Other; }
};
...
class Instr_addlw : public Instruction
{
	public:
		...
		virtual void generateLinksAndStates( Code::iterator current ) override;
		virtual ProcessorBehaviour behaviour() const override;
		virtual AssemblyType assemblyType() const override { return WorkingOriented; }
};
...
class Instr_sourceCode : public Instruction
{
	public:
		...
		virtual QString code() const override;
		virtual InstructionType type() const override { return Comment; }
		virtual AssemblyType assemblyType() const override { return None; }
};
...
class Instr_asm : public Instruction
{
	public:
		...
		virtual QString code() const override;
		virtual InstructionType type() const override { return Raw; }
		virtual AssemblyType assemblyType() const override { return None; }
};
