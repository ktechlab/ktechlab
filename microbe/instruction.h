...
public:
	 ...
	 */
	Register::Type registerType() const {
...
public:
	...
	QStringList queuedLabels(InstructionPosition position) const {
		return m_queuedLabels[position];
	}
	...
	InstructionList *instructionList(InstructionPosition position) {
		return & m_instructionLists[position];
	}
...
public:
	bool operator != (const CodeConstIterator &i) const {
		return it != i.it;
	}
...
public:
	...
	void setRegisterDepends(uchar depends, const Register &reg) {
		m_registerDepends.reg(reg) = depends;
	}
	...
	uchar registerDepends(const Register &reg) {
		return m_registerDepends.reg(reg);
	}
	...
	Register outputReg() const {
		return (m_dest == 0) ? Register::WORKING : m_file;
	}
...
public:
	Instr_addwf(const Register &file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_andwf(const Register &file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_clrf(const Register & file) {
		m_file = file;
		m_dest = 1;
	}
...
public:
	Instr_decf(const Register & file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_decfsz(const Register & file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_incf(const Register & file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_iorwf(const Register & file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_movwf(const Register &file) {
		m_file = file;
		m_dest = 1;
	}
...
public:
	Instr_rrf(const Register &file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_subwf(const Register &file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_swapf(const Register &file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_xorwf(const Register &file, int dest) {
		m_file = file;
		m_dest = dest;
	}
...
public:
	Instr_bcf(const Register &file, const RegisterBit &bit) {
		m_file = file;
		m_bit = bit;
	}
...
public:
	Instr_bsf(const Register &file, const RegisterBit &bit) {
		m_file = file;
		m_bit = bit;
	}
...
public:
	Instr_btfsc(const Register & file, const RegisterBit & bit) {
		m_file = file;
		m_bit = bit;
	}
...
public:
	Instr_call(const QString & label) {
		m_label = label;
	}
...
public:
	Instr_goto(const QString & label) {
		m_label = label;
	}
