 ...
 */
class KTLSHELL_EXPORT SourceFormatterController : public KDevelop::ISourceFormatterController
{
    Q_OBJECT
    ...
    public:
        ...
        */
        KDevelop::ISourceFormatter* activeFormatter();
        /** \return The formatter corresponding to the language
        * of the document corresponding to the \arg url.
        */
        KDevelop::ISourceFormatter* formatterForUrl(const KUrl &url);
        ...
        */
        KDevelop::ISourceFormatter* formatterForMimeType(const KMimeType::Ptr &mime);
    ...
    protected:
        ...
        */
        ...
        KDevelop::ISourceFormatter* formatterForLanguage(const QString &language);
        /** \return the formatter for the currently avtive language named \arg name.
        */
        KDevelop::ISourceFormatter* formatterByName(const QString &language, const QString &name);
    ...
    private:
        ...
        QHash<QString, KDevelop::ISourceFormatter*> m_currentPlugins;
