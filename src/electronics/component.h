...
class Component : public CNItem
{
	...
	public:
        ...
        Component( ICNDocument *icnDocument, bool newItem, const char* id ): Component(icnDocument, newItem, QString::fromLatin1(id)) {};
		virtual ~Component();
		...
		virtual void finishedCreation() override;
		/**
	...
	protected:
		...
		virtual void initPainter( QPainter &p ) override;
		/**
