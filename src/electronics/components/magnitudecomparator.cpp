...
void MagnitudeComparator_inStateChangedWithVal(void *objV, bool state) { // Enable
    MagnitudeComparator *objT = static_cast<MagnitudeComparator*>(objV);
    objT->inStateChangedWithVal(state);
}
...
{
    return new LibraryItem(QStringList(QString("ec/magnitudecomparator")), i18n("Magnitude Comparator"), i18n("Integrated Circuits"), "ic1.png", LibraryItem::lit_component, MagnitudeComparator::construct);
}
