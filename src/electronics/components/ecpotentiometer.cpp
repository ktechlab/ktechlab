...
{
    return new LibraryItem(QStringList(QString("ec/potentiometer")), i18n("Potentiometer"), i18n("Passive"), "potentiometer.png", LibraryItem::lit_component, ECPotentiometer::construct);
}
