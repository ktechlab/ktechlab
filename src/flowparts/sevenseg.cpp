...
{
    return new LibraryItem(QStringList(QString("flow/sevenseg")), i18n("Seven Segment"), i18n("Functions"), "seven_segment.png", LibraryItem::lit_flowpart, SevenSeg::construct);
}
