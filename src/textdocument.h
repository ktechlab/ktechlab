...
public:
	...
	virtual void fileSave() override { fileSave(url()); }
	...
	virtual bool isModified() const override { return m_doc->isModified(); }
	virtual bool isUndoAvailable() const override; // { return (m_doc->undoCount() != 0); }
	virtual bool isRedoAvailable() const override; // { return (m_doc->redoCount() != 0); }
