...
void ItemSelector::slotRemoveSelectedItem()
{
    ...
    Q_EMIT itemRemoved(item->data(0, ILVItem::DataRole_ID).toString() /*key( 0, 0 ) */);
...
void ItemSelector::slotItemSelected()
{
    ...
    Q_EMIT itemSelected(item->data(0, ILVItem::DataRole_ID).toString() /* item->key( 0, 0 ) */);
}
...
void ItemSelector::slotItemClicked(QTreeWidgetItem *item, int)
{
    ...
    Q_EMIT itemClicked(itemIdString /* item->key( 0, 0 ) */);
}
