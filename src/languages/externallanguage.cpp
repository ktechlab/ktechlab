...
void ExternalLanguage::resetLanguageProcess()
{
    ...
    connect(m_languageProcess, SIGNAL(readyReadStandardOutput()), this, SLOT(processStdout()));

    connect(m_languageProcess, SIGNAL(readyReadStandardError()), this, SLOT(processStderr()));

    connect(m_languageProcess, SIGNAL(finished(int, QProcess::ExitStatus)), this, SLOT(processExited(int, QProcess::ExitStatus)));
}
