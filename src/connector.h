...
/*
	TODO: Audit/enhance this code.
should probably be moved to electronics too. 
*/
...
Q_OBJECT
public:
	Connector( Node *startNode, Node *endNode, ICNDocument *_ICNDocument, QString *id = 0);
	~Connector();
	...
	Wire *wire( unsigned num = 0) const { return (num < m_wires.size()) ? m_wires[num] : 0; }
