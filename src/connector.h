...
public:
     ...
     */
    CNItem *parentContainer() const
    {
        return p_parentContainer;
    }
     ...
     */
    ICNDocument *icnDocument() const
    {
        return p_icnDocument;
    }
    ...
    */
    ...
    {
        return m_currentAnimationOffset;
    }
...
public:
    ...
    Connector *parent() const
    {
        return m_pConnector;
    }

    void setAnimateCurrent(bool animateCurrent)
    {
        m_bAnimateCurrent = animateCurrent;
    }
